    ...
    <div class="p-4 mt-14 text-center dark:text-white">
        ...
        <div class="w-full pt-5 mx-auto max-w-sm bg-green-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div class="flex flex-col items-center pb-10">
                <!-- <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="../assets/images/bird.jpg" alt="image" /> -->
                <div class="flex flex-col text-xl items-center gap-4">

                    <div>
                        <img src=" <?= '..' . $_SESSION['loggedInUser']['image'] ?>" style="width:100px;height:100px;" class="rounded-full mx-auto mb-3" alt="uploaded pic" />
                    </div>
