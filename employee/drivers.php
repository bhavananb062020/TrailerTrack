...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14 text-center dark:text-white">
        ...
        <div class="px-3 py-6 flex items-center justify-end">
            ...
            <a href="drivers-create.php" class="float-left text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Add driver</a>
        </div>
        <?= alertMessage(); ?>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="px-4 py-4 sm:px-6">
                                        <a href="driverDetails.php?id=<?= $Item['id']; ?>" type="button" class="text-white bg-blue-500 hover:bg-blue-500 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-green-800">View</a>
                                        <a href="drivers-edit.php?id=<?= $Item['id']; ?>" type="button" class="text-white bg-green-600 hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</a>
