...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14 text-center dark:text-white">
        ...
        <h1 class="mb-5 pb-5 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Edit Driver</span> </h1>
                ...
                <div>
                    ...
                    ?>
                        <div class="relative mb-3">
                            <img src="<?= '../' . $driver['data']['image']; ?>" style="width:100px;height:100px;" class="rounded-full mx-auto mb-3" alt="uploaded pic" />
                        ...
                        <div class="relative mb-3">
                            <input type="text" id="name" name="name" required value="<?= $driver['data']['name']; ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="relative mb-3">
                            <input type="text" id="phone" name="phone" value="<?= $driver['data']['phone']; ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="relative mb-3">
                            <input type="text" id="email" name="email" value="<?= $driver['data']['email']; ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="relative mb-3">
                            <input type="text" id="password" name="password" value="<?= $driver['data']['password']; ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="relative mb-3">
                            <input type="text" id="license" name="license" value="<?= $driver['data']['license']; ?>" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <input name="is_ban" type="checkbox" <?= $driver['data']['is_ban'] == true ? 'checked' : '' ?> class="w-7 h-7 text-green-600 bg-green-100 border-green-300 rounded focus:ring-green-500 dark:focus:ring-green-600 dark:ring-offset-green-800 focus:ring-2 dark:bg-green-700 dark:border-green-600">
                                <label class="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">Is Ban</label>
                            </div>
                            <div>
                                <button type="submit" name="updateDriver" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Update</button>
                            </div>
                        </div>
                        <!-- QR Code Display -->
                        <div class="mb-5">
                            <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-2">Driver QR Code</h3>
                            <img src="<?= '..' . $driver['data']['qr']; ?>" style="width:150px;height:150px;" class="mx-auto rounded" alt="Driver QR Code" />
