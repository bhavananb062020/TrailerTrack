...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14 text-center dark:text-white">
        <div class="px-3 mx-auto py-3 flex items-center">
            ...
            <a href="history.php" class=" text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Back</a>
                ...
                ?>
                        ...
                        <div class="bg-green-100 dark:bg-gray-700 rounded-lg p-2 mb-3">
                            ...
                            <div class="max-w-sm mx-auto p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-700 dark:border-gray-600">
                                <div class=" mb-3 pl-5  text-left">
                                    <div class="text-sm font-normal text-black dark:text-white mb-2 dark:text-gray-300"><strong>Location : </strong><?= $register['data']['location'] ?> </div>
                                    <div class="text-sm font-normal text-black dark:text-white mb-2 dark:text-gray-300"><strong>checked out by : </strong><?= $register['data']['checkout_by'] ?> </div>
                                    <div class="text-sm font-normal text-black dark:text-white mb-2 dark:text-gray-300"><strong>check out time : </strong><?= $register['data']['checkout_time'] ?> </div>
                                </div>
                            </div>
