...
<section class="flex flex-col items-center  justify-center py-5 my-5 w-full">
    ...
    <div class="w-full max-w-sm p-4 bg-green-100 border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" action="login-code.php" method="POST">
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Manager / Employee Login</h5>
            ...
            <button type="submit" name="loginBtn" class="w-full text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Login to your account</button>
