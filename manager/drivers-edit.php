                ...
                <div>
                    ...
                    ?>
                        ...
                        <div class="flex items-center justify-between mb-4">
                            <div>
                                <input name="is_ban" type="checkbox" <?= $driver['data']['is_ban'] == true ? 'checked' : '' ?> class="w-7 h-7 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
