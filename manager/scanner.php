    ...
    <div class="p-4 mt-14 text-center">
        ...
        <div class="max-w-lg mx-auto py-8 px-5 bg-green-100 dark:bg-gray-700 rounded-lg">
            ...
            <div class="flex justify-center space-x-2 mb-4">
                ...
                <button id="toggleFlash" type="button" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                    Toggle Flash
                </button>
            </div>
    ...
    function toggleFlash() {
        if (track) {
            ...
            if (capabilities.torch) {
                ...
                toggleFlashBtn.textContent = flashState ? "Turn Flash Off" : "Turn Flash On";
            } else {
