...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14 text-center dark:text-white">
        ...
        <h1 class="mb-5 pb-5 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Add User</span> </h1>
        ...
        <div class="max-w-md mx-auto bg-green-100 dark:bg-gray-700 p-4 rounded-lg">
            ...
            <form action="code.php" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <div class="relative mb-3">
                        <input type="text" id="center" name="center" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                    ...
                    <div class="mb-3 flex items-center justify-center gap-3">
                        <select id="role" name="role" class="bg-green-100 border border-green-300 text-green-900 text-sm rounded-lg focus:ring-green-500 focus:border-greeb-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div>
                            <button type="submit" name="saveUser" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Save</button>
