...
<div class="p-4 sm:ml-64">
    <div class="p-4 mt-14 text-center dark:text-white">
        ...
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Contact Us Enquries</span> </h1>
                ...
                <table id="myTable" class="w-full text-sm text-left text-gray-500 dark:text-gray-400 display nowrap">
                    <thead class="text-xs text-gray-700 uppercase bg-green-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3 sm:px-6">message</th>

                        </tr>
                    </thead>
                    <tbody>
                        <?php
                        $users = getAll('contact');

                        if (mysqli_num_rows($users) > 0) {
                            foreach ($users as $userItem) {
                        ?>
                                <tr>
                                    <td class="px-4 py-4 sm:px-6"> <?= $userItem['created_at']; ?></td>
                                    <td class="px-4 py-4 sm:px-6"><?= $userItem['name']; ?></td>
                                    <td class="px-4 py-4 sm:px-6"> <?= $userItem['email']; ?></td>
                                    <td class="px-4 py-4 sm:px-6"> <?= $userItem['message']; ?></td>
